...
typedef struct cl_enginefuncs_s
{
	...
	struct model_s* (*GetSpritePointer)			(HSPRITE hSprite);
	...
	void* (*pfnGetCareerUI)				(void);	// g-cont. !!!! potential crash-point!
	...
	struct cmdalias_t* (*pfnGetAliasList)				(void);
	void				(*pfnVguiWrap2_GetMouseDelta)	(int* x, int* y);

	int					(*pfnFilteredClientCmd)			(char* pszCmdString);
} cl_enginefunc_t;
